...
//	@DisplayName("상품명, 상품상세설명 or 테스트")
	public void findByItemNmOrItenDetailTest() {
		createItemTest();
...
//	@DisplayName("JPQL 테스트")
	public void javaPersistenceQueryLanguageTest() {
		createItemTest();
...
//	@DisplayName("JPQL 테스트")
	public void queryDSLTest() {
		...
		JPAQuery<Item> query = queryFactory.selectFrom(qItem).where(qItem.itemSellStatus.eq(ItemSellStatus.SELL))
				.where(qItem.itemDetail.like("%" + "테스트 상품 상세 설명3" + "%")).orderBy(qItem.price.desc());
